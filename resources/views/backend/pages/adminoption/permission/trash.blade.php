    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a class="text-danger" href="{{ route('permission.index') }}">Back<i style="font-size: 14px;" class="fa fa-arrow-right"></i></a>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                   ...
                                   <td class="d-flex justify-content-between">
                                    <a href="{{ route('permission.trash.update', $trash -> id) }}"><button class="btn btn-sm btn-info"><span class="btn btn-sm btn-info badge badge-info">Restore!</span></button></i></a>
                                    <form action="{{ route('permission.destroy', $trash -> id) }}" method="POST">
                                       @csrf
                                       @method('DELETE')
